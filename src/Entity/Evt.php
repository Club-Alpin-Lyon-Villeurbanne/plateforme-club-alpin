...
class Evt
{
    ...
    /**
     * Trie les participants par rôles.
     *
     * @param array|null $roles
     *   Les rôles à conserver.
     * @param int|null $status
     *   Les statuts à conserver.
     * @return Collection
     *   Une collection d'objets EvtJoin.
     * @throws \Exception
     */
    public function getParticipantsSortedByRoles(?array $roles = null, ?int $status = EvtJoin::STATUS_VALIDE): Collection
    {
        $participantsIterator = $this->getParticipants($roles, $status)->getIterator();
        $participantsIterator->uasort(function ($a, $b) {
            $rolesWeightedMatrix = [
                EvtJoin::ROLE_ENCADRANT => [
                    EvtJoin::ROLE_ENCADRANT => 0,
                    EvtJoin::ROLE_COENCADRANT => -1,
                    EvtJoin::ROLE_STAGIAIRE => -1,
                    EvtJoin::ROLE_BENEVOLE => -1,
                    EvtJoin::ROLE_INSCRIT => -1,
                    EvtJoin::ROLE_MANUEL => -1,
                ],
                EvtJoin::ROLE_COENCADRANT => [
                    EvtJoin::ROLE_ENCADRANT => 1,
                    EvtJoin::ROLE_COENCADRANT => 0,
                    EvtJoin::ROLE_STAGIAIRE => 1,
                    EvtJoin::ROLE_BENEVOLE => -1,
                    EvtJoin::ROLE_INSCRIT => -1,
                    EvtJoin::ROLE_MANUEL => -1,
                ],
                EvtJoin::ROLE_STAGIAIRE => [
                    EvtJoin::ROLE_ENCADRANT => 1,
                    EvtJoin::ROLE_COENCADRANT => -1,
                    EvtJoin::ROLE_STAGIAIRE => 0,
                    EvtJoin::ROLE_BENEVOLE => -1,
                    EvtJoin::ROLE_INSCRIT => -1,
                    EvtJoin::ROLE_MANUEL => -1,
                ],
                EvtJoin::ROLE_BENEVOLE => [
                    ...
                    EvtJoin::ROLE_COENCADRANT => 1,
                    EvtJoin::ROLE_STAGIAIRE => 1,
                    EvtJoin::ROLE_BENEVOLE => 0,
                    EvtJoin::ROLE_INSCRIT => 0,
                    EvtJoin::ROLE_MANUEL => 0,
                ],
                EvtJoin::ROLE_INSCRIT => [
                    EvtJoin::ROLE_ENCADRANT => 1,
                    EvtJoin::ROLE_COENCADRANT => 1,
                    EvtJoin::ROLE_STAGIAIRE => 1,
                    EvtJoin::ROLE_BENEVOLE => 0,
            ...
            return $rolesWeightedMatrix[$a->getRole()][$b->getRole()];
        });
        return new ArrayCollection(iterator_to_array($participantsIterator));
    }
