...
class ArticleRepository extends ServiceEntityRepository
{
    ...
    /** @return Article[] */
    public function getArticles(?Commission $commission = null, ?int $first = 0, ?int $perPage = 10): array
    {
     ...
     */
    public function getArticlesByCommissionCount(?Commission $commission = null)
    {
        return $this
    ...
    protected function getArticlesByCommissionDql(?Commission $commission = null)
    {
