...
class ArticleUnpublishVoter extends Voter
{
    ...
    {
        return \in_array($attribute, ['ARTICLE_UNPUBLISH'], true);
    }
    ...
    protected function voteOnAttribute($attribute, $subject, TokenInterface $token): bool
    {
        ...
        return $this->userRights->allowedOnCommission('article_validate', $commission) || $this->userRights->allowed('article_validate_all');
    }
}
