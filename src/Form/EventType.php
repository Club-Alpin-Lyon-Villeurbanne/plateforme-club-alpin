    ...
    protected function getStuffList(): array
    {
        ...
        return match ($this->club) {
            'lyon' => [
                ...
                'Rando raquettes' => "Carte du CAF Imprimée recto-verso, Vitale, Mutuelle. Sac à dos adapté à la randonnée raquettes (avec des sangles) et suffisamment grand pour contenir les vêtements de l'activité extérieure (30 L) : fourrure polaire, goretex ou équivalent, sur-sac, bonnet, gants, lunettes de soleil (masque suivant météo), crème solaire, guêtres. Bâtons avec grosses rondelles de neige / Kit de sécurité - comprenant DVA, pelle et sonde - qui peut être réservé au CAF via l’application LOXYA. Voir onglet matériel :CAF Lyon - Gestion du matériel. Prévoir un jeu de piles ALCALINE de rechange pour le DVA. Raquettes adaptées à vos chaussures et réglées au préalable. Crampons a minima forestiers (contacter l'encadrant.e) ou d’alpinisme. COUVERTURE DE SURVIE OBLIGATOIRE. Pique-nique et boisson (thermos ou gourde ou autre). / Autres matériels suivant information de l'encadrant.e / Chaussures de rechange pour la voiture (avec sac plastique). Pour le covoiturage : espèces ou autre moyen comme WERO.",
