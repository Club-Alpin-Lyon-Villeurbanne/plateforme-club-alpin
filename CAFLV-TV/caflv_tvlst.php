...
if(preg_match("#^sorties#", $_GET['mode'])){
		...
		$entry['commission']=$handle['commission']['title_commission']; //$handle['commission_evt'];
                $entry['img'] = false;
...
// fin modif Daniel
        ...
        //$newItem->setTitle('<tspan font-weight="bold">  -'.$tvDate.'-</tspan> '.$entry['title']);
        $newItem->setTitle($tvDate.' '.$entry['commission'].': '.$entry['title']);
