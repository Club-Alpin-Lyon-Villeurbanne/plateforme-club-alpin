	...
	<div id="left1">
		<div class="main-type">
			...
			if(!allowed('evt_legal_accept')){
				...
				// liste :
				if(!$notif_validerunesortie_president) echo '<p class="info">Aucune sortie n\'est en attente de validation pour l\'instant.</p>';
				else{
							...
							echo '<tr>'
									...
									.'<td>'
										...
										.'<div class="evt-tools">'
											...
											// apercu
											.'<a class="nice2" href="sortie/'.html_utf8($evt['code_evt']).'-'.intval($evt['id_evt']).'.html?forceshow=true" title="Ouvre une nouvelle fenêtre de votre navigateur pour jeter un oeil à la page avant validation" target="_blank">Aperçu / validation de la page</a> '
