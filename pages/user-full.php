...
<div id="main" role="main" class="bigoo" style="">
	...
	<div id="left1">
		<div style="padding:20px">
			<?php
			if(!allowed('user_read_limited')) echo '<br /><br /><p class="erreur">Désolé. Vous n\'avez pas les droit requis pour afficher cette page.</p>';
			elseif(!$tmpUser) echo '<br /><br /><p class="erreur">Cet utilisateur est introuvable.</p>';
			else{
                ...
                <?php
                    ...
                    if ($ecriture || $lecture) { echo '<br style="clear:both" /><hr /><h2>Son niveau</h2>'; }
                    if ($ecriture) { 
