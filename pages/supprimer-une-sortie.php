...
<div id="main" role="main" class="bigoo" style="">
	...
	<div id="left1">
		<div class="main-type">
			...
			if(user()){
				// droits
				if(!allowed('evt_delete')) echo '<br /><br /><br /><p class="erreur">Vous ne semblez pas disposer des droits de suppression.</p>';
				...
				if($evt && !$errPage){
					...
					<form action="<?php echo $versCettePage;?>" method="post" class="loading">
						...
						<?php
						// TABLEAU
						if($_POST['operation'] == 'evt_del' && sizeof($errTab))	echo '<div class="erreur">Erreur : <ul><li>'.implode('</li><li>', $errTab).'</li></ul></div>';
						if($_POST['operation'] == 'evt_del' && !sizeof($errTab))	echo '<p class="info">Cette sortie a été annulée.</p>';
						?>
						<br />
