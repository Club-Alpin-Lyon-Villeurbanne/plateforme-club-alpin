<div id="main" role="main">
	...
	if(true){
		...
		if(true){
			...
			$devCommission='vtt';
			if(allowed('article_create', 'commission:'.$devCommission))	echo "J'ai le droit de créer un article pour la commission $devCommission<hr />";
			else{ echo "Vous n'avez pas les droits nécessaire pour créer un article pour la commission $devCommission<hr />"; }
