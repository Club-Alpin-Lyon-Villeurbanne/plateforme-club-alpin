...
<div id="main" role="main" class="bigoo" style="">
	...
	<div id="left1">
		<div class="main-type">
			<?php
			if(!allowed('comm_create')) echo '<p class="erreur">Vous n\'avez pas les droits nécessaires pour afficher cette page</p>';
			else{
				?>
				...
				<form action="<?php echo $versCettePage;?>" method="post" enctype="multipart/form-data" class="loading">
					...
					if($_POST['operation'] == 'commission_add' && sizeof($errTab))	echo '<div class="erreur">Erreur : <ul><li>'.implode('</li><li>', $errTab).'</li></ul></div>';
					if($_POST['operation'] == 'commission_add' && !sizeof($errTab))	echo '<p class="info">Mise à jour effectuée à '.date("H:i:s", $p_time).'.</p>';
					?>
