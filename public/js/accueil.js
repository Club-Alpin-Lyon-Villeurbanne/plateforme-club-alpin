...
$().ready(function() {
	...
	function slideTo(index){
		if(typeof(index)=="undefined") sliderIndex++; // pas défini, incrementation
		...
		else{					 sliderIndex=parseInt(index); clearInterval(sliderInterval); } // index donné (navigation)
	...
	$('#home-slider-nav a').bind('click' ,function(){
		slideTo($(this).index()-1); // on donne l'index -1 à cause de l'image qui précède les liens et compte dans le compte
	});
	// bind to arrows
