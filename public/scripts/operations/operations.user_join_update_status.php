        ...
        foreach ($_POST['id_evt_join'] as $id_evt_join) {
            ...
            if ($id_evt_join) {
                ...
                if (array_key_exists('status_evt_join_'.$id_evt_join, $_POST)) {
                    $status_evt_join_new = $mysqli->real_escape_string((int) ($_POST['status_evt_join_'.$id_evt_join]));
                    $send_mail = true;
                }
                $role_evt_join_new = '';
                ...
                if ((strlen($status_evt_join_new) > 0 && ($status_evt_join_new != $status_evt_join)) || (strlen($role_evt_join_new) > 0 && (0 != strcmp($role_evt_join_new, $role_evt_join)))) {
                    ...
                    if (!isset($errTab) || 0 === count($errTab)) {
                        ...
                        if (strlen($role_evt_join_new) > 0 && (0 != strcmp($role_evt_join_new, $role_evt_join))) {
