	...
	<div id="left1">
        ...
        if (!$currentPage2) {
            ...
            if (!$currentPage2['vis_page']) {
                echo '<p class="info" style="position:relative; top:35px;">Cette page n\'est pas accessible aux visiteurs du site. Pour la rendre visible, prenez le temps de modifier les contenus ci-dessous, puis rendez-vous dans <a href="'.($p_multilangue ? $lang.'/' : '').'admin-pages-libres.html" title="">l\'espace d\'administration des pages</a>.</p><br />';
            }
