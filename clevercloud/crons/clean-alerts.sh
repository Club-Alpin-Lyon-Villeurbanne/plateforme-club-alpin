...
# Requires HEALTHCHECK_CLEAN_ALERTS env var to be set with healthchecks.io UUID
init_healthcheck "HEALTHCHECK_CLEAN_ALERTS" "clean-alerts"

cd ${APP_HOME}
bin/console clean-alerts