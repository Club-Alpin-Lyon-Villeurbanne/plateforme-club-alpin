...
if(admin()){
	...
	if($code_content_html){
		...
		if($mysqli->query($req)) $result['success']=true;
		$log.="\n req :  ".$req;
		...
		else $result['content']='<div class="blocdesactive"><img src="img/base/bullet_key.png" alt="" title="" /> Bloc de contenu désactivé</div>';
		$log.="\n retour : ".$result['content'];
	}
	else $result['error']='code_content_html missing';
