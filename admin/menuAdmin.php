...
if(admin()){
	?>
	<div id="menuAdmin" style="<?php if($p_pageadmin) echo 'position:relative';?>">
		<!-- specs -->
		...
		<div style="margin-left:160px">
			...
			foreach($p_pages as $code=>$datas){
				...
				if($datas['menuadmin_page']){
					...
					if(!$datas['superadmin_page'] or superadmin()){
						// cas particulier : la page traductions seulement en cas de langues multiples
						if($code!='admin-traductions' or sizeof($p_langs)>1){
			...
			<!--
			<a href="<?php echo $p_multilangue?$lang.'/':''; ?>admin-contenus.html" title="" class="adminmenulink <?php if($p1=='admin-contenus') echo 'up';?>">Contenus statiques</a>
			<?php if(sizeof($p_langs)>1){ ?>
				<a href="<?php echo $p_multilangue?$lang.'/':''; ?>admin-traductions.html" title="" class="adminmenulink <?php if($p1=='admin-traductions') echo 'up';?>">Traductions</a>
			<?php } ?>
			
			<a href="<?php echo $p_multilangue?$lang.'/':''; ?>admin-actus.html" title="" class="adminmenulink <?php if($p1=='admin-actus') echo 'up';?>">Actualités</a>
			<a href="<?php echo $p_multilangue?$lang.'/':''; ?>admin-reas.html" title="Organisez vos réalisations" class="adminmenulink <?php if($p1=='admin-reas') echo 'up';?>">Réalisations</a>
			<a href="<?php echo $p_multilangue?$lang.'/':''; ?>admin-partenaires.html" title="Organisez l'onglet valeurs en pied de page" class="adminmenulink <?php if($p1=='admin-partenaires') echo 'up';?>">Onglet "Partenaires"</a>
			<a href="<?php echo $p_multilangue?$lang.'/':''; ?>admin-newsletter.html" title="Inscrits à la newsletter" class="adminmenulink <?php if($p1=='admin-newsletter') echo 'up';?>">Newsletter</a>
			-->
