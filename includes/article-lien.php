...
if($article['commission']['code_commission']) 	$url.='?commission='.$article['commission']['code_commission']; // V2 commission de cet article
elseif($article['evt']['code_commission']) 		$url.='?commission='.$article['evt']['code_commission']; // commission de la sortie associée
...
<div class="encart_article">
	...
	<p class="commission-title">
		...
		// 0 = actu club
		elseif($article['commission_article']==0){
			?>
		...
		elseif($article['commission_article'] == -1){
