    ...
    <div class="trigger-me">
        ...
        <div style="float:right; padding-right:20px;">
            <select>
                ...
                <option value="Carte CAF, vêtements pour activité extérieure, fourrure polaire, coupe-vent, casquette, lunettes de soleil, crème solaire, appareil photos.  SANS OUBLIER : DVA, sonde, pelle (et raquettes) qui peuvent être prêtés par le CAF contre participation aux frais.">Ski alpinisme / Rando raquettes </option>
