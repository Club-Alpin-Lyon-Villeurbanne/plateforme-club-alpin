    ...
    for ($i = 0; $i < count($tab); ++$i) {
        ...
        echo '<tr id="tr-' . $elt['id_page'] . '" class="' . ($elt['vis_page'] ? 'vis-on' : 'vis-off') . '">'
                    . '<td style="width:120px">'
                        ...
                        . '<a href="' . LegacyContainer::get('legacy_router')->generate('legacy_root', [], UrlGeneratorInterface::ABSOLUTE_URL) . 'pages/' . HtmlHelper::escape($elt['code_page']) . '.html" title="Modifier cette page"><img src="/img/base/page_edit.png" alt="EDIT" title="Modifier cette page" /></a> &nbsp;'
                    ...
                    . '<td><a href="/pages/' . HtmlHelper::escape($elt['code_page']) . '.html" title="">/pages/' . HtmlHelper::escape($elt['code_page']) . '.html</a></td>'
