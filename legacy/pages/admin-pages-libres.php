    ...
    $().ready(function(){
            ...
            $.ajax({
                ...
                success: function(jsonMsg){
                    if(jsonMsg.success){
                        ...
                        showModal('<p class="erreur">Erreur : <br />'+(jsonMsg.error).join(',<br />')+'</p>');
                    }
                }
            });
        ...
        $('a.majVis').bind('click', function(){
            ...
            if(id){
                ...
                if(!edit)	showModal($('#noteditedyet').html());
                else{
                    if(hidden)  showModal($('#confirm-afficher').html());
                    else		showModal($('#confirm-masquer').html());
                }
            }
            return false;
        });
