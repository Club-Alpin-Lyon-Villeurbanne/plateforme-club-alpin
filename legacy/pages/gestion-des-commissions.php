                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    if ($action) {
                        ...
                        echo '<div class="item ' . (1 == $row['vis_commission'] ? 'on' : 'off') . '">'
                                    ...
                                    // bigfond
                                    if (!empty($bigImgUrl)) {
                                        echo '<a href="javascript:void(0)" title="" onclick="modal.show(getElementById(\'image-preview-' . (int) $row['id_commission'] . '\').innerHTML)"><img style="width:100%" src="' . $bigImgUrl . '" alt="" title="Agrandir" /></a>';
                                    }
                                    echo '<br />'
                                    // pictos
