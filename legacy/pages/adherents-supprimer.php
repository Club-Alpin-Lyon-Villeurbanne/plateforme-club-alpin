...
if (!isGranted(SecurityConstants::ROLE_ADMIN)) {
    ...
    if (isset($_POST['operation']) && 'user_delete' == $_POST['operation'] && (!isset($errTab) || 0 === count($errTab))) {
        echo '<p class="info">Utilisateur supprimé ! (Vous devrez <a href="javascript:top.modal.close();top.frames.location.reload(false);">Recharger la page</a> pour voir le changement)</p>';
    } else {
        ?>
