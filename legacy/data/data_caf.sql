...
(22, 'profil-sorties-self', 'fr', '<h2><span class="bleucaf">&gt;</span> Retrouvez ci-dessous la liste des sorties que vous proposez, de la plus lointaine dans le futur à la plus lointaine dans le passé.</h2>', 1367229138, '', 1, 1),
