...
?>
    ...
    <div class="trigger-me" style="padding-right:20px">
        ...
        <div id="inscriptions-on" style="display:block">
            ...
            <p class="mini">
                <input type="number" min="0" name="ngens_max_evt" class="type2" style="width:40px; text-align:center" value="<?php echo inputVal('ngens_max_evt', ''); ?>" placeholder=" ex : 8" />
            ...
            <div style="width:45%; padding-right:3%; float:left">
                ...
                <input type="number" min="0" name="join_start_evt_days" class="type2" style="width:40px; text-align:center" value="<?php echo inputVal('join_start_evt_days', ''); ?>" placeholder=" > 2" required/>
								<span class="mini">
            ...
            <div style="width:50%; float:left">
                ...
                <input type="number" min="0" name="join_max_evt" class="type2" style="width:40px; text-align:center" value="<?php echo inputVal('join_max_evt', ''); ?>" placeholder="ex : 5" />
                <span class="mini">
