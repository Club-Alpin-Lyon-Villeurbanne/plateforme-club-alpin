...
if ($evt) {
    echo '<div class="evt-tools">'
        ...
        . (allowed('evt_edit', 'commission:' . $evt['code_commission']) ? '<a class="nice2 orange" href="/modifier-une-sortie/' . (int) $evt['id_evt'] . '" title="Modifier la sortie ci-dessous et les encadrants liés">Modifier</a>' : '')
