...
<div class="droite">
    ...
    <p>
        ...
        // rôle de l'user dans cette sortie
            if (user() && $destination['id_user_responsable'] == (string) getUser()->getId()) {
                echo ' - Votre rôle : <b> Encadrant </b>';
            } elseif (user() && $destination['id_user_adjoint'] == (string) getUser()->getId()) {
                echo ' - Votre rôle : <b> Co-encadrant </b>';
            } elseif (user() && $destination['id_user_who_create'] == (string) getUser()->getId()) {
