<?php
	...
	$id_user_mailchange=intval($tab[1]);
	...
	if($id_user_mailchange){
		...
		if(!$found) $errTab[]="Cette requête est introuvable";
		$mysqli->close();
	}
	else $errTab[]="Erreur de données (id)";
