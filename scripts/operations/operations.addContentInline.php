<?php
	...
	$linkedtopage_content_inline=intval($_POST['linkedtopage_content_inline']);
	...
	if(!preg_match($pattern, $code_content_inline))		$errTab[]="Erreur de formatage du code : celui-ci ne peut comporter que des minuscules et des tirets";
	if(strlen($lang_content_inline)!=2)					$errTab[]="Erreur de langue";
