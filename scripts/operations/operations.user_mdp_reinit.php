<?php
	...
	if(strlen($mdp_user)<5 or strlen($mdp_user)>12) 	$errTab[]=$fieldsErrTab['mdp_user']="Le mot de passe doit faire entre 5 et 12 caractères";
	if(strpos($mdp_user, ' '))						$errTab[]=$fieldsErrTab['mdp_user']="Le mot de passe ne doit pas comporter d'espace";
	...
	while($handle=$handleSql->fetch_array(MYSQLI_ASSOC)){
		...
		else $id_user_mdpchange=$mysqli->insert_id;
	}
	// compte introuvable
	if(!$found)
