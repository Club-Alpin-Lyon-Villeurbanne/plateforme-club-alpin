...
final class Version20250613064218 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE caf_evt ADD event_start_date DATETIME DEFAULT NULL COMMENT \'date et heure du début du event(DC2Type:datetime_immutable)\', ADD event_end_date DATETIME DEFAULT NULL COMMENT \'date et heure de fin du event(DC2Type:datetime_immutable)\', ADD join_start_date DATETIME DEFAULT NULL COMMENT \'date du début des inscriptions(DC2Type:datetime_immutable)\'');
