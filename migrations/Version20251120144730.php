 ...
 */
final class Version20251120144730 extends AbstractMigration
{
    ...
    {
        $this->addSql('DELETE FROM caf_page WHERE code_page = \'user-full\'');
    }
    ...
    public function down(Schema $schema): void
    {
        $this->addSql(<<<SQL
            ...
            VALUES (0, 0, 0, 1, 0, 0, 0, 0, 0, 'user-full', 'Profil adhérent', 0, 0, 0.0, '', '', 0, 0, 0);
        SQL);
    }
}
