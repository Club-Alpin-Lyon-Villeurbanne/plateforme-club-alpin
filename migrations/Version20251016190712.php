...
final class Version20251016190712 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE formation_brevet_referentiel (id INT AUTO_INCREMENT NOT NULL, code_brevet VARCHAR(50) NOT NULL, intitule VARCHAR(255) NOT NULL, UNIQUE INDEX idx_code_brevet (code_brevet), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
