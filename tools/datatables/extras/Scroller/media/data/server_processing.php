<?php
	...
	$sQuery = "
		...
		$sLimit
	";
	$rResult = $mysqli->query( $sQuery, $gaSql['link'] ) or die($mysqli->error);
	
	/* Data set length after filtering */
	$sQuery = "
		SELECT FOUND_ROWS()
	";
	$rResultFilterTotal = $mysqli->query( $sQuery, $gaSql['link'] ) or die($mysqli->error);
	...
	$sQuery = "
		...
		FROM   $sTable
	";
	$rResultTotal = $mysqli->query( $sQuery, $gaSql['link'] ) or die($mysqli->error);
