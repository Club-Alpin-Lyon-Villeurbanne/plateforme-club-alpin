...
// $errTab[]="Test";
if(!user() && !admin())	$errTab[]="User non connecté";
elseif(!$_SESSION['user']['id_user'] && !admin())	$errTab[]="ID manquant";

if (admin()) $_SESSION['user']['id_user'] = 0;

if(!sizeof($errTab)){
	$targetDir='ftp/user/'.intval($_SESSION['user']['id_user']).'/images/'; // depuis la racine
	if (!is_dir($targetDir))
		mkdir($targetDir, 0777, true);
		else chmod($targetDir, 0777);
